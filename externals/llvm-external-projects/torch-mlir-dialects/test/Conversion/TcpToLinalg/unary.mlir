...
func.func @cast_i1(%arg0 : tensor<?x?xi32>) -> tensor<?x?xi1> {
  %0 = tcp.cast %arg0 {in_dtype = 1 : ui32, out_dtype = 0 : ui32} : tensor<?x?xi32> -> tensor<?x?xi1>
...
func.func @cast_si8_f32(%arg0 : tensor<?x?xi8>) -> tensor<?x?xf32> {
  %0 = tcp.cast %arg0 {in_dtype = 1 : ui32} : tensor<?x?xi8> -> tensor<?x?xf32>
  return %0 : tensor<?x?xf32>
}
...
func.func @cast_si8_ui32(%arg0 : tensor<?x?xi8>) -> tensor<?x?xi32> {
  %0 = tcp.cast %arg0 {in_dtype = 1 : ui32, out_dtype = 2 : ui32} : tensor<?x?xi8> -> tensor<?x?xi32>
  return %0 : tensor<?x?xi32>
}
