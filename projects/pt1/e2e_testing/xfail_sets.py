...
FX_IMPORTER_STABLEHLO_XFAIL_SET = {
    ...
    "IndexPutBoolMask2DModule_multiple_true",
    "IndexPutBoolMask4DModule_basic",
    "IndexPutBoolMaskAccumulateModule_basic",
    "IndexPutBoolMaskDynamicModule_basic",
    "IndexPutMixedIntBoolModule_basic",
    ...
    "QuantizedDecomposedChooseQparamsPerTokenAsymmetric_basic",
    "QuantizedDecomposedChooseQparamsPerTokenSymmetric_basic",
    "QuantizedDecomposedDequantizePerToken3D_basic",
    "QuantizedDecomposedDequantizePerToken_basic",
    "QuantizedDecomposedQuantizePerToken3D_basic",
    "QuantizedDecomposedQuantizePerToken_basic",
    "QuantizedDecomposedDynamicQuantPerTokenAsymmetric3D_basic",
    "QuantizedDecomposedDynamicQuantPerTokenAsymmetric_basic",
    "QuantizedDecomposedDynamicQuantPerTokenSymmetric_basic",
    "QuantizedMLP_basic",
    "QuantizedNoLayer_basic",
    "QuantizedSingleLayer_basic",
...
ONNX_XFAIL_SET = {
    ...
    "AtenAsStridedAfterBroadcastToModule_basic",
    "AtenAsStridedAfterChainedViewsModule_basic",
    "AtenAsStridedAfterContiguousModule_basic",
    "AtenAsStridedAfterExpandAsModule_basic",
    "AtenAsStridedAfterExpandModule_basic",
    "AtenAsStridedAfterReshapeFlattenModule_basic",
    "AtenAsStridedAfterSliceModule_basic",
...
ONNX_CRASHING_SET = LINALG_CRASHING_SET | {
    ...
    "EmbeddingModuleI64_basic",
    # Regressed by the switch to the dynamo ONNX exporter, see https://github.com/llvm/torch-mlir/issues/4690.
    # These failed softly under the TorchScript exporter and now abort the process,
    # which kills the whole run in framework.run_tests, so they cannot stay in ONNX_XFAIL_SET.
    "AtenComplex64Module_basic",
    "AtenComplexImagModule_basic",
    "AtenComplexRealModule_basic",
    "AtenRealView128Module_basic",
...
# Inherited from LINALG_CRASHING_SET, but no longer crashing through the ONNX path with the dynamo exporter, see https://github.com/llvm/torch-mlir/issues/4690
ONNX_CRASHING_SET -= {
    "ConvolutionModule2DTransposeStridedStatic_basic",
    "ConvolutionModule2DTransposeStrided_basic",
    "Conv_Transpose1dModule_basic",
