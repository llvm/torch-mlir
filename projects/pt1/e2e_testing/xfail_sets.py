...
STABLEHLO_PASS_SET = {
    ...
    "TensorsColumnStackFloatModule_basic",
    "TensorsColumnStackIntFloatComplexModule_basic",
    "TensorsColumnStackIntFloatModule_basic",
    "TensorsColumnStackIntModule_basic",
    "TestF16Return_basic",
    "TestMultipleTensorAndPrimitiveTypesReturn_basic",
