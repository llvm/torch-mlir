...
def lower_sdpa() -> None:
    ...
    if "torch.aten.scaled_dot_product_attention.default" in module_str:
        raise RuntimeError("scaled_dot_product_attention unexpectedly survived lowering")
...
if __name__ == "__main__":
    ...
    lower_sdpa()
    print("CHECK: lowered scaled dot product attention")
    print("SUCCESS")
# CHECK: CHECK: lowered scaled dot product attention
# CHECK: SUCCESS
