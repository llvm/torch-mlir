...
if __name__ == "__main__":
    ...
    for activation in ("gelu", "relu"):
        for norm_first in (True, False):
            ...
            print(f"lowered norm_first={norm_first} activation={activation}")

    print("SUCCESS")
# CHECK: lowered norm_first=True activation=gelu
# CHECK: lowered norm_first=False activation=gelu
# CHECK: lowered norm_first=True activation=relu
# CHECK: lowered norm_first=False activation=relu
# CHECK: SUCCESS
