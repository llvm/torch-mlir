...
class AtenNonzero2DModule(torch.nn.Module):
    def __init__(self):
        super().__init__()
...
@register_test_case(module_factory=lambda: AtenNonzero2DModule())
def AtenNonzero2DModule_basic(module, tu: TestUtils):
