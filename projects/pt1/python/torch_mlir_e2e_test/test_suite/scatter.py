...
class IndexPutImpl1DFloatNonAccumulateModule(torch.nn.Module):
    ...
    def forward(self, input, index, value):
        return torch.ops.aten._index_put_impl_(
            input, (index,), value, accumulate=False, unsafe=False
        )
...
def IndexPutImpl1DIntNonAccumulateModule_basic(module, tu: TestUtils):
    module.forward(
        tu.randint(200, high=1000),
        tu.randint(300, high=100),
...
class IndexPutImpl1DFloatAccumulateModule(torch.nn.Module):
    ...
    def forward(self, input, index, value):
        return torch.ops.aten._index_put_impl_(
            input, (index,), value, accumulate=True, unsafe=False
        )
...
class IndexPutImpl2DFloatAccumulateModule(torch.nn.Module):
    ...
    def forward(self, input, index, value):
        return torch.ops.aten._index_put_impl_(
            input.clone(), (index,), value, accumulate=True, unsafe=False
        )
...
def IndexPutImpl1DIntAccumulateModule_basic(module, tu: TestUtils):
    module.forward(
        tu.randint(10, high=100), tu.randint(10, high=10), tu.randint(10, high=1000)
    )
...
@register_test_case(module_factory=lambda: IndexPut2DFloatNonAccumulateModule())
...
@register_test_case(module_factory=lambda: IndexPut3DFloatNonAccumulateModule())
...
def IndexPut2DIntNonAccumulateModule_basic(module, tu: TestUtils):
    module.forward(
        tu.randint(10, 8, high=1000), tu.randint(5, high=4), tu.randint(5, 8, high=1000)
    )
...
@register_test_case(module_factory=lambda: ScatterSrcStaticModule())
...
@register_test_case(module_factory=lambda: ScatterSrcModule())
def ScatterSrcModule_basic(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(3, 4, 3))
...
@register_test_case(module_factory=lambda: ScatterValueFloatModule())
def ScatterValueFloatModule_basic(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand().double())
...
@register_test_case(module_factory=lambda: ScatterValueIntModule())
def ScatterValueIntModule_basic(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.randint(high=10))
...
def ScatterAddDynamicModule_basic(module, tu: TestUtils):
    module.forward(torch.tensor([0, 0, 0, 0, 0, 0]), torch.tensor([0, 0, 0,  0,  0,  0]), torch.tensor([0, 0, 0, 3, 0, 0]))
...
class ScatterReduceFloatModule(torch.nn.Module):
    ...
    def forward(self, input, index, src):
        return torch.ops.aten.scatter_reduce(
            input, 0, index, src, self.reduce_type, include_self=self.include_self
        )


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("sum", False))
def ScatterReduceFloatSumModule(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(5, 8, 6))


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("sum", True))
def ScatterReduceFloatSumModuleIncludeSelf(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(5, 8, 6))


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("prod", False))
def ScatterReduceFloatProdModule(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(5, 8, 6))


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("prod", True))
def ScatterReduceFloatProdModuleIncludeSelf(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(5, 8, 6))


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("amax", False))
def ScatterReduceFloatMaxModule(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(5, 8, 6))


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("amax", True))
def ScatterReduceFloatMaxModuleIncludeSelf(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(5, 8, 6))


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("amin", False))
def ScatterReduceFloatMinModule(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(5, 8, 6))


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("amin", True))
def ScatterReduceFloatMinModuleIncludeSelf(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(5, 8, 6))


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("mean", False))
def ScatterReduceFloatMeanModule(module, tu: TestUtils):
    module.forward(tu.rand(10, 8, 6), tu.randint(2, 4, 3, high=4), tu.rand(5, 8, 6))


@register_test_case(module_factory=lambda: ScatterReduceFloatModule("mean", True))
...
@register_test_case(module_factory=lambda: ScatterReduceIntModule("sum", False))
def ScatterReduceIntSumModule(module, tu: TestUtils):
    module.forward(
        tu.randint(10, 8, 6, dtype=torch.int32, high=10),
        tu.randint(2, 4, 3, high=4),
        tu.randint(5, 8, 6, dtype=torch.int32, high=10),
    )


@register_test_case(module_factory=lambda: ScatterReduceIntModule("sum", True))
...
@register_test_case(module_factory=lambda: ScatterReduceIntModule("prod", False))
...
@register_test_case(module_factory=lambda: ScatterReduceIntModule("prod", True))
...
@register_test_case(module_factory=lambda: ScatterReduceIntModule("amax", False))
...
@register_test_case(module_factory=lambda: ScatterReduceIntModule("amax", True))
...
@register_test_case(module_factory=lambda: ScatterReduceIntModule("amin", False))
...
@register_test_case(module_factory=lambda: ScatterReduceIntModule("amin", True))
...
@register_test_case(module_factory=lambda: ScatterReduceIntModule("mean", False))
...
@register_test_case(module_factory=lambda: ScatterReduceIntModule("mean", True))
...
@register_test_case(module_factory=lambda: IndexPutImpl2DIndexModule())
...
class IndexPutImplIndexWithNoneModule(torch.nn.Module):
    ...
    def forward(self, input, index1, index2, value):
        return torch.ops.aten._index_put_impl_(
            input, (None, None, index1, index2), value, accumulate=True, unsafe=False
        )


@register_test_case(module_factory=lambda: IndexPutImplIndexWithNoneModule())
