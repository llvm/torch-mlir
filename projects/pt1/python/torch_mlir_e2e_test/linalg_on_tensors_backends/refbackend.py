...
LOWERING_PIPELINE = (
    ...
    + ",".join(
        [
            ...
            # Buffer deallocation pass does not know how to how to handle realloc.
            ...
            # FIXME: Buffer-deallocation does not work with the inlined code
            # generated by sparse tensor dialect.
