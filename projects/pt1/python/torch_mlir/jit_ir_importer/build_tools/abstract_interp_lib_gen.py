...
def aten〇_scaled_mm_v2〡shape(self: List[int], mat2: List[int], scale_a: List[List[int]], scale_recipe_a: List[int], swizzle_a: List[int], scale_b: List[List[int]], scale_recipe_b: List[int], swizzle_b: List[int], bias: Optional[List[int]], out_dtype: Optional[int], contraction_dim: List[int], use_fast_accum: bool) -> List[int]:
    return upstream_shape_functions.mm(self, mat2)
...
def aten〇_scaled_mm_v2〡dtype(self_rank_dtype: Tuple[int, int], mat2_rank_dtype: Tuple[int, int], scale_a_rank_dtype: List[Tuple[int, int]], scale_recipe_a: List[int], swizzle_a: List[int], scale_b_rank_dtype: List[Tuple[int, int]], scale_recipe_b: List[int], swizzle_b: List[int], bias_rank_dtype: Optional[Tuple[int, int]], out_dtype: Optional[int], contraction_dim: List[int], use_fast_accum: bool) -> int:
    self_rank, self_dtype = self_rank_dtype
    if out_dtype is not None:
        return out_dtype
    return self_dtype
