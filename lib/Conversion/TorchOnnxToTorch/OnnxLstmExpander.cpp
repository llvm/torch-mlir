...
LogicalResult OnnxLstmExpander(OpBinder binder,
  ...
  if (binder.tensorOperandAtIndex(initial_h, 5)) {
    ...
    initial_h = rewriter.create<Torch::AtenZerosOp>(loc, HType,
                                                    initial_hc_shape, cstDtype,
                                                    /*layout*/ cst_None,
                                                    /*device*/ cst_None,
                                                    /*pin_memory*/ cst_None);
  }
  if (binder.tensorOperandAtIndex(initial_c, 6)) {
    ...
    initial_c = rewriter.create<Torch::AtenZerosOp>(loc, HType,
                                                    initial_hc_shape, cstDtype,
                                                    /*layout*/ cst_None,
                                                    /*device*/ cst_None,
                                                    /*pin_memory*/ cst_None);
  ...
  Value Y_nonumdirections =
      rewriter.create<Torch::AtenStackOp>(loc, Y_nonumdirections_type, Y_list,
                                          /*dim*/ cst_Zero);
