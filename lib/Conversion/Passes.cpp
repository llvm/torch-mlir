...
namespace torch_conversion {
#define GEN_PASS_REGISTRATION
#include "torch-mlir/Conversion/Passes.h.inc"
} // end namespace torch_conversion

void mlir::torch::registerConversionPasses() {
  torch_conversion::registerPasses();

  // Register backend pipelines that lower from the torch backend contract to
  // various backend contracts. These pipelines are registered here because
  // they depend on all the individual conversion passes registered above.
