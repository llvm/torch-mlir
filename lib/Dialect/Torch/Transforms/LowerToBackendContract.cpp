...
static void markDecomposedOpsAsIllegal(MLIRContext *context,
  ...
  target.addIllegalOp<AtenStftOp>();
  target.addIllegalOp<AtenStftCenterOp>();
  ...
  target.addIllegalOp<AtenAddbmmOp>();
  ...
  target.addIllegalOp<AtenMultiplyTensorOp>();
  target.addIllegalOp<AtenMultiplyScalarOp>();
