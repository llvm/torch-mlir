...
"    %1 = torch.prim.If %0 -> (!torch.int) {\n"
"      %8 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"      %9 = torch.aten.add.int %arg1, %8 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %9 : !torch.int\n"
"    } else {\n"
"      torch.prim.If.yield %arg1 : !torch.int\n"
"    }\n"
...
"    %5 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"    %6 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"    %7 = torch.prim.Loop %6, %true, init(%5) {\n"
"    ^bb0(%arg3: !torch.int, %arg4: !torch.list<int>):\n"
"      %8 = torch.aten.ne.int %arg3, %1 : !torch.int, !torch.int -> !torch.bool\n"
"      %9 = torch.prim.If %8 -> (!torch.list<int>) {\n"
"        %10 = torch.aten.__getitem__.t %arg0, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %11 = torch.aten.append.t %arg4, %10 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"        torch.prim.If.yield %arg4 : !torch.list<int>\n"
"      } else {\n"
"        %10 = torch.aten.add.t %arg4, %4 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"        torch.prim.If.yield %10 : !torch.list<int>\n"
"      }\n"
"      torch.prim.Loop.condition %true, iter(%9 : !torch.list<int>)\n"
