...
"    %str = torch.constant.str \"size must be less than {}\"\n"
"    %none = torch.constant.none\n"
"    %str_0 = torch.constant.str \"AssertionError: \"\n"
...
"    %2 = torch.prim.If %1 -> (!torch.int) {\n"
"      %13 = torch.aten.add.int %arg1, %0 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %13 : !torch.int\n"
"    } else {\n"
"      torch.prim.If.yield %arg1 : !torch.int\n"
"    }\n"
...
"    %4 = torch.prim.If %3 -> (!torch.bool) {\n"
"      %13 = torch.aten.lt.int %2, %0 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %13 : !torch.bool\n"
"    } else {\n"
"      torch.prim.If.yield %false : !torch.bool\n"
"    }\n"
...
"      torch.prim.If.yield\n"
"    } else {\n"
"      %13 = torch.aten.format(%str_1, %0) : !torch.str, !torch.int -> !torch.str\n"
"      %14 = torch.aten.add.str %str_0, %13 : !torch.str, !torch.str -> !torch.str\n"
"      torch.prim.RaiseException %14, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
...
"      torch.prim.If.yield\n"
"    } else {\n"
"      %13 = torch.aten.format(%str, %5) : !torch.str, !torch.int -> !torch.str\n"
"      %14 = torch.aten.add.str %str_0, %13 : !torch.str, !torch.str -> !torch.str\n"
"      torch.prim.RaiseException %14, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
...
"    %11 = torch.aten._set_item.t %10, %2, %9 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"    %12 = torch.aten.append.t %10, %arg2 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"    return %10 : !torch.list<int>\n"
"  }\n"
