...
"    return %14 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.stft.center\"(%arg0: !torch.list<int>, %arg1: !torch.int, %arg2: !torch.optional<int>, %arg3: !torch.optional<int>, %arg4: !torch.optional<list<int>>, %arg5: !torch.bool, %arg6: !torch.str, %arg7: !torch.bool, %arg8: !torch.optional<bool>, %arg9: !torch.optional<bool>) -> !torch.list<int> {\n"
"    %str = torch.constant.str \"AssertionError: Expected hop_length to be greater than 0\"\n"
"    %str_0 = torch.constant.str \"AssertionError: Expected that 0 < n_fft <= len\"\n"
"    %false = torch.constant.bool false\n"
"    %none = torch.constant.none\n"
...
"      %22 = torch.operator \"aten.eq.bool\"(%21, %true) : (!torch.bool, !torch.bool) -> !torch.bool \n"
"      torch.prim.If.yield %22 : !torch.bool\n"
"    }\n"
"    torch.prim.If %17 -> () {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %18 = torch.operator \"aten.eq.bool\"(%arg5, %true) : (!torch.bool, !torch.bool) -> !torch.bool \n"
"    torch.prim.If %18 -> () {\n"
...
"      %22 = torch.operator \"aten.eq.bool\"(%21, %false) : (!torch.bool, !torch.bool) -> !torch.bool \n"
"      torch.prim.If.yield %22 : !torch.bool\n"
"    } else {\n"
"      torch.prim.If.yield %false : !torch.bool\n"
"    }\n"
...
"    return %6 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.stft.center\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.int, %arg2: !torch.optional<int>, %arg3: !torch.optional<int>, %arg4: !torch.optional<tuple<int, int>>, %arg5: !torch.bool, %arg6: !torch.str, %arg7: !torch.bool, %arg8: !torch.optional<bool>, %arg9: !torch.optional<bool>) -> !torch.int {\n"
"    %str = torch.constant.str \"AssertionError: Unsupported dtype\"\n"
"    %int7 = torch.constant.int 7\n"
"    %int10 = torch.constant.int 10\n"
"    %int6 = torch.constant.int 6\n"
