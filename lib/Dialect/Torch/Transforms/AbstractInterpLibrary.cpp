...
"    %int0 = torch.constant.int 0\n"
"    %int1 = torch.constant.int 1\n"
"    %0 = torch.aten.__getitem__.t %arg1, %int2 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %1 = torch.aten.__getitem__.t %arg1, %int3 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %2 = torch.prim.ListConstruct %0, %1 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %3 = torch.prim.ListConstruct %int0, %int0 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %4 = torch.operator \"aten.mul.left_t\"(%3, %int2) : (!torch.list<int>, !torch.int) -> !torch.list<int> \n"
"    %5 = torch.aten.eq.str %arg4, %str : !torch.str, !torch.str -> !torch.bool\n"
"    torch.prim.If %5 -> () {\n"
"      %7 = torch.aten.len.t %arg5 : !torch.list<int> -> !torch.int\n"
"      %8 = torch.aten.__range_length %int1, %int-1, %int-1 : !torch.int, !torch.int, !torch.int -> !torch.int\n"
"      %9 = torch.prim.ListConstruct %7, %int2, %8 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"      %10 = torch.prim.min.self_int %9 : !torch.list<int> -> !torch.int\n"
"      torch.prim.Loop %10, %true, init() {\n"
"      ^bb0(%arg7: !torch.int):\n"
"        %11 = torch.aten.__getitem__.t %arg5, %arg7 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %12 = torch.aten.__getitem__.t %2, %arg7 : !torch.list<int>, !torch.int -> !torch.int\n"
...
"        %18 = torch.aten._set_item.t %4, %17, %16 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
...
"        %22 = torch.aten._set_item.t %4, %21, %19 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      torch.prim.If.yield\n"
"    } else {\n"
"      torch.prim.If.yield\n"
"    }\n"
"    %6 = call @__torch__.torch.jit._shape_functions.conv2d(%arg0, %arg1, %arg2, %arg3, %4, %arg5, %arg6) : (!torch.list<int>, !torch.list<int>, !torch.optional<list<int>>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int) -> !torch.list<int>\n"
"    return %6 : !torch.list<int>\n"
"  }\n"
