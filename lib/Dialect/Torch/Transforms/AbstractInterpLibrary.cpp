...
"    %4 = torch.prim.If %3 -> (!torch.bool) {\n"
"      %15 = torch.aten.lt.int %arg7, %2 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %15 : !torch.bool\n"
"    } else {\n"
"      torch.prim.If.yield %false : !torch.bool\n"
"    }\n"
...
"      torch.prim.If.yield\n"
"    } else {\n"
"      %15 = torch.aten.sub.int %2, %int1 : !torch.int, !torch.int -> !torch.int\n"
"      %16 = torch.aten.format(%str_2, %15) : !torch.str, !torch.int -> !torch.str\n"
"      %17 = torch.aten.add.str %str_1, %16 : !torch.str, !torch.str -> !torch.str\n"
"      torch.prim.RaiseException %17, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
...
"    ^bb0(%arg8: !torch.int):\n"
"      %15 = torch.aten.__getitem__.t %9, %arg8 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"      %16 = torch.aten.__getitem__.t %8, %arg8 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"      %17 = torch.aten.len.t %16 : !torch.list<int> -> !torch.int\n"
"      %18 = torch.aten.len.t %15 : !torch.list<int> -> !torch.int\n"
"      torch.prim.Loop %18, %true, init() {\n"
"      ^bb0(%arg9: !torch.int):\n"
"        %19 = torch.aten.__getitem__.t %15, %arg9 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %20 = torch.aten.le.int %19, %17 : !torch.int, !torch.int -> !torch.bool\n"
"        torch.prim.If %20 -> () {\n"
"          torch.prim.If.yield\n"
"        } else {\n"
"          %22 = torch.aten.__getitem__.t %8, %arg8 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"          %23 = torch.aten.format(%str_0, %19, %22) : !torch.str, !torch.int, !torch.list<int> -> !torch.str\n"
"          %24 = torch.aten.add.str %str_1, %23 : !torch.str, !torch.str -> !torch.str\n"
"          torch.prim.RaiseException %24, %none : !torch.str, !torch.none\n"
"          torch.prim.If.yield\n"
"        }\n"
"        %21 = torch.aten.__getitem__.t %8, %arg8 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"        torch.aten.insert.t %21, %19, %int1 : !torch.list<int>, !torch.int, !torch.int\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
...
"    %12 = torch.aten.eq.int %10, %11 : !torch.int, !torch.int -> !torch.bool\n"
"    %13 = torch.prim.If %12 -> (!torch.bool) {\n"
"      %15 = torch.aten.len.t %6 : !torch.list<int> -> !torch.int\n"
"      %16 = torch.aten.len.t %7 : !torch.list<int> -> !torch.int\n"
"      %17 = torch.aten.eq.int %15, %16 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %17 : !torch.bool\n"
"    } else {\n"
"      torch.prim.If.yield %false : !torch.bool\n"
