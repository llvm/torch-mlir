...
"    %0 = call @__torch__._max_pool1d(%arg0, %arg1, %arg2, %arg3, %arg4, %arg5) : (!torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool) -> !torch.list<int>\n"
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @__torch__._max_pool1d(%arg0: !torch.list<int>, %arg1: !torch.list<int>, %arg2: !torch.list<int>, %arg3: !torch.list<int>, %arg4: !torch.list<int>, %arg5: !torch.bool) -> !torch.list<int> {\n"
"    %int-1 = torch.constant.int -1\n"
"    %int-2 = torch.constant.int -2\n"
"    %int-3 = torch.constant.int -3\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
"    %str_0 = torch.constant.str \"AssertionError: max_pool1d: dilation must be a single int\"\n"
"    %str_1 = torch.constant.str \"AssertionError: max_pool1d: padding must be a single int\"\n"
"    %str_2 = torch.constant.str \"AssertionError: avg_pool1d: stride must either be omitted, or a single int\"\n"
"    %true = torch.constant.bool true\n"
"    %none = torch.constant.none\n"
"    %str_3 = torch.constant.str \"AssertionError: max_pool1d: kernel_size must be a single int\"\n"
"    %int1 = torch.constant.int 1\n"
"    %int0 = torch.constant.int 0\n"
"    %int2 = torch.constant.int 2\n"
"    %int3 = torch.constant.int 3\n"
...
"      torch.prim.If.yield %true : !torch.bool\n"
"    } else {\n"
"      %27 = torch.aten.len.t %arg2 : !torch.list<int> -> !torch.int\n"
"      %28 = torch.aten.eq.int %27, %int1 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %28 : !torch.bool\n"
"    }\n"
"    torch.prim.If %5 -> () {\n"
"      torch.prim.If.yield\n"
...
"      torch.prim.If.yield %2 : !torch.int\n"
"    } else {\n"
"      %27 = torch.aten.__getitem__.t %arg2, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %27 : !torch.int\n"
"    }\n"
"    %9 = torch.aten.len.t %arg3 : !torch.list<int> -> !torch.int\n"
...
"    %12 = torch.aten.len.t %arg4 : !torch.list<int> -> !torch.int\n"
"    %13 = torch.aten.eq.int %12, %int1 : !torch.int, !torch.int -> !torch.bool\n"
"    torch.prim.If %13 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
"      torch.prim.RaiseException %str_0, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
"    %14 = torch.aten.__getitem__.t %arg4, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %15 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"    %16 = torch.aten.eq.int %15, %int2 : !torch.int, !torch.int -> !torch.bool\n"
"    %17 = torch.prim.If %16 -> (!torch.bool) {\n"
"      torch.prim.If.yield %true : !torch.bool\n"
"    } else {\n"
"      %27 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"      %28 = torch.aten.eq.int %27, %int3 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %28 : !torch.bool\n"
"    }\n"
"    torch.prim.If %17 -> () {\n"
"      torch.prim.If.yield\n"
...
"    }\n"
"    %18 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"    %19 = torch.aten.eq.int %18, %int3 : !torch.int, !torch.int -> !torch.bool\n"
"    %20 = torch.prim.If %19 -> (!torch.int) {\n"
"      %27 = torch.aten.__getitem__.t %arg0, %int-3 : !torch.list<int>, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %27 : !torch.int\n"
"    } else {\n"
"      torch.prim.If.yield %int1 : !torch.int\n"
"    }\n"
"    %21 = torch.aten.__getitem__.t %arg0, %int-2 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %22 = torch.aten.__getitem__.t %arg0, %int-1 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %23 = call @__torch__.torch.jit._shape_functions.pooling_output_shape(%22, %2, %11, %8, %14, %arg5) : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.bool) -> !torch.int\n"
"    %24 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"    %25 = torch.aten.eq.int %24, %int2 : !torch.int, !torch.int -> !torch.bool\n"
"    %26 = torch.prim.If %25 -> (!torch.list<int>) {\n"
"      %27 = torch.prim.ListConstruct %21, %23 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"      torch.prim.If.yield %27 : !torch.list<int>\n"
"    } else {\n"
"      %27 = torch.prim.ListConstruct %20, %21, %23 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"      torch.prim.If.yield %27 : !torch.list<int>\n"
"    }\n"
"    return %26 : !torch.list<int>\n"
"  }\n"
