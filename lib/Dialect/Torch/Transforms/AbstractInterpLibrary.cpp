...
"    %int3 = torch.constant.int 3\n"
"    %int-1 = torch.constant.int -1\n"
"    %str = torch.constant.str \"a\"\n"
"    %str_0 = torch.constant.str \"AssertionError: number of dimensions must match\"\n"
"    %str_1 = torch.constant.str \"expand dimension {} is out of bounds for input of shape {}\"\n"
"    %true = torch.constant.bool true\n"
"    %none = torch.constant.none\n"
"    %str_2 = torch.constant.str \"AssertionError: \"\n"
"    %str_3 = torch.constant.str \"unroll_dim must be in [0, {}]\"\n"
"    %false = torch.constant.bool false\n"
"    %int0 = torch.constant.int 0\n"
"    %int1 = torch.constant.int 1\n"
"    %0 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
...
"    %4 = torch.prim.If %3 -> (!torch.bool) {\n"
"      %22 = torch.aten.lt.int %arg7, %2 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %22 : !torch.bool\n"
"    } else {\n"
"      torch.prim.If.yield %false : !torch.bool\n"
"    }\n"
...
"      torch.prim.If.yield\n"
"    } else {\n"
"      %22 = torch.aten.sub.int %2, %int1 : !torch.int, !torch.int -> !torch.int\n"
"      %23 = torch.aten.format(%str_3, %22) : !torch.str, !torch.int -> !torch.str\n"
"      %24 = torch.aten.add.str %str_2, %23 : !torch.str, !torch.str -> !torch.str\n"
"      torch.prim.RaiseException %24, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
...
"    ^bb0(%arg8: !torch.int):\n"
"      %22 = torch.aten.__getitem__.t %8, %arg8 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
...
"      %25 = torch.aten.len.t %23 : !torch.list<int> -> !torch.int\n"
"      torch.prim.Loop %25, %true, init() {\n"
"      ^bb0(%arg9: !torch.int):\n"
"        %26 = torch.aten.__getitem__.t %23, %arg9 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %27 = torch.aten.le.int %26, %24 : !torch.int, !torch.int -> !torch.bool\n"
"        torch.prim.If %27 -> () {\n"
"          torch.prim.If.yield\n"
"        } else {\n"
"          %28 = torch.aten.format(%str_1, %26, %22) : !torch.str, !torch.int, !torch.list<int> -> !torch.str\n"
"          %29 = torch.aten.add.str %str_2, %28 : !torch.str, !torch.str -> !torch.str\n"
"          torch.prim.RaiseException %29, %none : !torch.str, !torch.none\n"
"          torch.prim.If.yield\n"
"        }\n"
"        torch.aten.insert.t %22, %26, %int1 : !torch.list<int>, !torch.int, !torch.int\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
...
"    %12 = torch.aten.eq.int %10, %11 : !torch.int, !torch.int -> !torch.bool\n"
"    %13 = torch.prim.If %12 -> (!torch.bool) {\n"
"      %22 = torch.aten.len.t %6 : !torch.list<int> -> !torch.int\n"
"      %23 = torch.aten.len.t %7 : !torch.list<int> -> !torch.int\n"
...
"    torch.prim.Loop %18, %true, init() {\n"
"    ^bb0(%arg8: !torch.int):\n"
"      %22 = torch.aten.__getitem__.t %arg6, %arg8 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %23 = torch.aten._set_item.t %17, %22, %true : !torch.list<bool>, !torch.int, !torch.bool -> !torch.list<bool>\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    torch.prim.Print(%str) : !torch.str\n"
...
"    torch.prim.Loop %21, %true, init() {\n"
"    ^bb0(%arg8: !torch.int):\n"
"      %22 = torch.aten.__derive_index %arg8, %20, %int-1 : !torch.int, !torch.int, !torch.int -> !torch.int\n"
"      %23 = torch.aten.__getitem__.t %17, %22 : !torch.list<bool>, !torch.int -> !torch.bool\n"
"      torch.prim.If %23 -> () {\n"
"        %24 = torch.operator \"aten.pop.t\"(%14, %22) : (!torch.list<int>, !torch.int) -> !torch.int \n"
"        torch.prim.If.yield\n"
"      } else {\n"
"        torch.prim.If.yield\n"
"      }\n"
