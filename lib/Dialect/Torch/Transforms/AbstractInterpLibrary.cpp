...
"    %none = torch.constant.none\n"
"    %str = torch.constant.str \"AssertionError: Dimension out of range\"\n"
"    %false = torch.constant.bool false\n"
"    %true = torch.constant.bool true\n"
"    %int1 = torch.constant.int 1\n"
"    %int0 = torch.constant.int 0\n"
...
"    torch.prim.Loop %1, %true, init() {\n"
"    ^bb0(%arg2: !torch.int):\n"
"      %3 = torch.aten.__getitem__.t %arg0, %arg2 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"      %4 = torch.aten.len.t %3 : !torch.list<int> -> !torch.int\n"
"      %5 = torch.aten.add.int %4, %int1 : !torch.int, !torch.int -> !torch.int\n"
"      %6 = torch.aten.neg.int %5 : !torch.int -> !torch.int\n"
"      %7 = torch.aten.le.int %6, %arg1 : !torch.int, !torch.int -> !torch.bool\n"
"      %8 = torch.prim.If %7 -> (!torch.bool) {\n"
"        %13 = torch.aten.lt.int %arg1, %5 : !torch.int, !torch.int -> !torch.bool\n"
"        torch.prim.If.yield %13 : !torch.bool\n"
"      } else {\n"
"        torch.prim.If.yield %false : !torch.bool\n"
"      }\n"
...
"        torch.prim.If.yield\n"
"      }\n"
"      %9 = torch.aten.ge.int %arg1, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"      %10 = torch.prim.If %9 -> (!torch.int) {\n"
"        torch.prim.If.yield %arg1 : !torch.int\n"
"      } else {\n"
"        %13 = torch.aten.add.int %arg1, %5 : !torch.int, !torch.int -> !torch.int\n"
"        torch.prim.If.yield %13 : !torch.int\n"
"      }\n"
"      %11 = func.call @__torch__.torch.jit._shape_functions._copy(%3) : (!torch.list<int>) -> !torch.list<int>\n"
"      torch.aten.insert.t %11, %10, %int1 : !torch.list<int>, !torch.int, !torch.int\n"
"      %12 = torch.aten.append.t %0, %11 : !torch.list<list<int>>, !torch.list<int> -> !torch.list<list<int>>\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    %2 = call @__torch__.torch.jit._shape_functions.cat(%0, %arg1) : (!torch.list<list<int>>, !torch.int) -> !torch.list<int>\n"
"    return %2 : !torch.list<int>\n"
"  }\n"
