...
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.embedding_dense_backward\"(%arg0: !torch.list<int>, %arg1: !torch.list<int>, %arg2: !torch.int, %arg3: !torch.int, %arg4: !torch.bool) -> !torch.list<int> {\n"
"    %none = torch.constant.none\n"
"    %int1 = torch.constant.int 1\n"
"    %0 = torch.prim.ListConstruct %arg2 : (!torch.int) -> !torch.list<int>\n"
"    %1 = torch.aten.len.t %arg1 : !torch.list<int> -> !torch.int\n"
"    %2 = torch.aten.slice.t %arg0, %1, %none, %int1 : !torch.list<int>, !torch.int, !torch.none, !torch.int -> !torch.list<int>\n"
"    %3 = torch.aten.add.t %0, %2 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    return %3 : !torch.list<int>\n"
"  }\n"
...
"    return %0#1 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.embedding_dense_backward\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.tuple<int, int>, %arg2: !torch.int, %arg3: !torch.int, %arg4: !torch.bool) -> !torch.int {\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    return %0#1 : !torch.int\n"
"  }\n"
