...
"    %0 = call @__torch__.unflatten(%arg0, %arg1, %arg2) : (!torch.list<int>, !torch.int, !torch.list<int>) -> !torch.list<int>\n"
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @__torch__.unflatten(%arg0: !torch.list<int>, %arg1: !torch.int, %arg2: !torch.list<int>) -> !torch.list<int> {\n"
"    %true = torch.constant.bool true\n"
"    %int-1 = torch.constant.int -1\n"
"    %none = torch.constant.none\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
...
"    %1 = torch.prim.If %0 -> (!torch.int) {\n"
"      %17 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"      %18 = torch.aten.add.int %arg1, %17 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %18 : !torch.int\n"
"    } else {\n"
"      torch.prim.If.yield %arg1 : !torch.int\n"
"    }\n"
...
"    %3 = torch.prim.If %2 -> (!torch.bool) {\n"
"      %17 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"      %18 = torch.aten.lt.int %1, %17 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %18 : !torch.bool\n"
"    } else {\n"
"      torch.prim.If.yield %false : !torch.bool\n"
"    }\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %4 = torch.operator \"aten.count.int\"(%arg2, %int-1) : (!torch.list<int>, !torch.int) -> !torch.int\n"
...
"    }\n"
"    %6 = torch.aten.len.t %arg2 : !torch.list<int> -> !torch.int\n"
"    %7 = torch.prim.Loop %6, %true, init(%int1) {\n"
"    ^bb0(%arg3: !torch.int, %arg4: !torch.int):\n"
"      %17 = torch.aten.__getitem__.t %arg2, %arg3 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %18 = torch.aten.ne.int %17, %int-1 : !torch.int, !torch.int -> !torch.bool\n"
"      %19 = torch.prim.If %18 -> (!torch.int) {\n"
"        %20 = torch.aten.mul.int %arg4, %17 : !torch.int, !torch.int -> !torch.int\n"
"        torch.prim.If.yield %20 : !torch.int\n"
"      } else {\n"
"        torch.prim.If.yield %arg4 : !torch.int\n"
"      }\n"
"      torch.prim.Loop.condition %true, iter(%19 : !torch.int)\n"
"    } : (!torch.int, !torch.bool, !torch.int) -> !torch.int\n"
"    %8 = torch.aten.__contains__.int_list %arg2, %int-1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %9 = torch.prim.If %8 -> (!torch.int) {\n"
"      %17 = torch.aten.__getitem__.t %arg0, %1 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %18 = torch.aten.floordiv.int %17, %7 : !torch.int, !torch.int -> !torch.int\n"
"      %19 = torch.aten.__getitem__.t %arg0, %1 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %20 = torch.aten.remainder.int %19, %7 : !torch.int, !torch.int -> !torch.int\n"
"      %21 = torch.aten.eq.int %20, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If %21 -> () {\n"
"        torch.prim.If.yield\n"
"      } else {\n"
"        torch.prim.RaiseException %str, %none : !torch.str, !torch.none\n"
"        torch.prim.If.yield\n"
"      }\n"
"      %22 = torch.operator \"aten.index.list_int\"(%arg2, %int-1) : (!torch.list<int>, !torch.int) -> !torch.int\n"
"      %23 = torch.aten._set_item.t %arg2, %22, %18 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"      %24 = torch.aten.mul.int %7, %18 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %24 : !torch.int\n"
"    } else {\n"
"      torch.prim.If.yield %7 : !torch.int\n"
"    }\n"
"    %10 = torch.aten.__getitem__.t %arg0, %1 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %11 = torch.aten.eq.int %9, %10 : !torch.int, !torch.int -> !torch.bool\n"
"    torch.prim.If %11 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
"      torch.prim.RaiseException %str, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
"    %12 = torch.aten.slice.t %arg0, %none, %1, %int1 : !torch.list<int>, !torch.none, !torch.int, !torch.int -> !torch.list<int>\n"
"    %13 = torch.aten.add.t %12, %arg2 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %14 = torch.aten.add.int %1, %int1 : !torch.int, !torch.int -> !torch.int\n"
"    %15 = torch.aten.slice.t %arg0, %14, %none, %int1 : !torch.list<int>, !torch.int, !torch.none, !torch.int -> !torch.list<int>\n"
"    %16 = torch.aten.add.t %13, %15 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    return %16 : !torch.list<int>\n"
"  }\n"
