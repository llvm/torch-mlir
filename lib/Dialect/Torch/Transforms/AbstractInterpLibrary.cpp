...
"    %12 = torch.prim.Loop %int9223372036854775807, %11, init(%int0) {\n"
"    ^bb0(%arg4: !torch.int, %arg5: !torch.int):\n"
"      %16 = torch.aten.__getitem__.t %arg0, %arg5 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %17 = torch.aten.eq.int %arg5, %3 : !torch.int, !torch.int -> !torch.bool\n"
"      %18 = torch.prim.If %17 -> (!torch.bool) {\n"
"        torch.prim.If.yield %true : !torch.bool\n"
"      } else {\n"
"        %22 = torch.aten.eq.int %arg5, %5 : !torch.int, !torch.int -> !torch.bool\n"
"        torch.prim.If.yield %22 : !torch.bool\n"
"      }\n"
"      torch.prim.If %18 -> () {\n"
"        torch.prim.If.yield\n"
"      } else {\n"
"        %22 = torch.aten.append.t %7, %16 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"        torch.prim.If.yield\n"
"      }\n"
"      %19 = torch.aten.add.int %arg5, %int1 : !torch.int, !torch.int -> !torch.int\n"
"      %20 = torch.aten.lt.int %19, %10 : !torch.int, !torch.int -> !torch.bool\n"
"      %21 = torch.aten.__and__.bool %20, %true : !torch.bool, !torch.bool -> !torch.bool\n"
"      torch.prim.Loop.condition %21, iter(%19 : !torch.int)\n"
"    } : (!torch.int, !torch.bool, !torch.int) -> !torch.int\n"
"    %13 = torch.aten.lt.int %arg1, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %14 = torch.prim.If %13 -> (!torch.int) {\n"
"      %16 = torch.aten.__getitem__.t %arg0, %3 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %17 = torch.aten.add.int %16, %arg1 : !torch.int, !torch.int -> !torch.int\n"
"      %18 = torch.aten.__getitem__.t %arg0, %5 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %19 = torch.prim.min.int %17, %18 : !torch.int, !torch.int -> !torch.int\n"
"      %20 = torch.prim.max.int %19, %int0 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %20 : !torch.int\n"
"    } else {\n"
"      %16 = torch.aten.__getitem__.t %arg0, %3 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %17 = torch.aten.__getitem__.t %arg0, %5 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %18 = torch.aten.sub.int %17, %arg1 : !torch.int, !torch.int -> !torch.int\n"
"      %19 = torch.prim.min.int %16, %18 : !torch.int, !torch.int -> !torch.int\n"
"      %20 = torch.prim.max.int %19, %int0 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %20 : !torch.int\n"
"    }\n"
"    %15 = torch.aten.append.t %7, %14 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"    return %7 : !torch.list<int>\n"
"  func.func @\"__torch_mlir_shape_fn.aten.tan\"(%arg0: !torch.list<int>) -> !torch.list<int> {\n"
"    %0 = call @__torch__.torch.jit._shape_functions.unary(%arg0) : (!torch.list<int>) -> !torch.list<int>\n"
"    return %0 : !torch.list<int>\n"
