...
"      torch.prim.If.yield\n"
"    }\n"
"    %3 = call @__torch__.torch_mlir.jit_ir_importer.build_tools.library_generator.is_integer_dtype(%1#1) : (!torch.int) -> !torch.bool\n"
...
"      %7 = torch.prim.TupleConstruct %0#1, %int7 : !torch.int, !torch.int -> !torch.tuple<int, int>\n"
"      torch.prim.If.yield %7 : !torch.tuple<int, int>\n"
"    } else {\n"
"      %7 = torch.aten.eq.int %1#1, %int9 : !torch.int, !torch.int -> !torch.bool\n"
"      %8 = torch.prim.If %7 -> (!torch.tuple<int, int>) {\n"
"        %9 = torch.prim.TupleConstruct %0#1, %int6 : !torch.int, !torch.int -> !torch.tuple<int, int>\n"
"        torch.prim.If.yield %9 : !torch.tuple<int, int>\n"
"      } else {\n"
"        %9 = torch.prim.TupleConstruct %0#1, %1#1 : !torch.int, !torch.int -> !torch.tuple<int, int>\n"
"        torch.prim.If.yield %9 : !torch.tuple<int, int>\n"
"      }\n"
"      torch.prim.If.yield %8 : !torch.tuple<int, int>\n"
"    }\n"
"    return %6 : !torch.tuple<int, int>\n"
"  }\n"
