...
"      torch.prim.If.yield\n"
"    }\n"
"    %3 = torch.aten.eq.int %0#1, %int5 : !torch.int, !torch.int -> !torch.bool\n"
"    %4 = torch.prim.If %3 -> (!torch.tuple<int, int, int>) {\n"
"      %5 = torch.prim.TupleConstruct %0#1, %int6, %int6 : !torch.int, !torch.int, !torch.int -> !torch.tuple<int, int, int>\n"
"      torch.prim.If.yield %5 : !torch.tuple<int, int, int>\n"
"    } else {\n"
"      %5 = torch.aten.eq.int %0#1, %int9 : !torch.int, !torch.int -> !torch.bool\n"
"      %6 = torch.prim.If %5 -> (!torch.tuple<int, int, int>) {\n"
"        %7 = torch.prim.TupleConstruct %0#1, %0#1, %int6 : !torch.int, !torch.int, !torch.int -> !torch.tuple<int, int, int>\n"
"        torch.prim.If.yield %7 : !torch.tuple<int, int, int>\n"
"      } else {\n"
"        %7 = torch.aten.eq.int %0#1, %int10 : !torch.int, !torch.int -> !torch.bool\n"
"        %8 = torch.prim.If %7 -> (!torch.tuple<int, int, int>) {\n"
"          %9 = torch.prim.TupleConstruct %0#1, %0#1, %int7 : !torch.int, !torch.int, !torch.int -> !torch.tuple<int, int, int>\n"
"          torch.prim.If.yield %9 : !torch.tuple<int, int, int>\n"
"        } else {\n"
"          %9 = torch.prim.TupleConstruct %0#1, %0#1, %0#1 : !torch.int, !torch.int, !torch.int -> !torch.tuple<int, int, int>\n"
"          torch.prim.If.yield %9 : !torch.tuple<int, int, int>\n"
"        }\n"
"        torch.prim.If.yield %8 : !torch.tuple<int, int, int>\n"
"      }\n"
"      torch.prim.If.yield %6 : !torch.tuple<int, int, int>\n"
"    }\n"
