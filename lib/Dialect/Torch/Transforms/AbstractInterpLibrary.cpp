...
"    %6 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.is_float_dtype(%3) : (!torch.int) -> !torch.bool\n"
"    torch.prim.If %6 -> () {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %7 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.is_float_dtype(%4) : (!torch.int) -> !torch.bool\n"
"    torch.prim.If %7 -> () {\n"
"      %11 = func.call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.is_integer_dtype(%0#1) : (!torch.int) -> !torch.bool\n"
"      %12 = torch.aten.__not__ %11 : !torch.bool -> !torch.bool\n"
"      torch.prim.If %12 -> () {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %8 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.is_float_dtype(%5) : (!torch.int) -> !torch.bool\n"
"    torch.prim.If %8 -> () {\n"
"      %11 = func.call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.is_integer_dtype(%0#1) : (!torch.int) -> !torch.bool\n"
"      %12 = torch.aten.__not__ %11 : !torch.bool -> !torch.bool\n"
"      torch.prim.If %12 -> () {\n"
