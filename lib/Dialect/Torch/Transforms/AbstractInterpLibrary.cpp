...
"    %int1 = torch.constant.int 1\n"
"    %0 = call @__torch__.adaptive_max_pool(%arg0, %arg1, %int1) : (!torch.list<int>, !torch.list<int>, !torch.int) -> !torch.tuple<list<int>, list<int>>\n"
"    return %0 : !torch.tuple<list<int>, list<int>>\n"
"  }\n"
"  func.func @__torch__.adaptive_max_pool(%arg0: !torch.list<int>, %arg1: !torch.list<int>, %arg2: !torch.int) -> !torch.tuple<list<int>, list<int>> {\n"
"    %true = torch.constant.bool true\n"
"    %none = torch.constant.none\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
"    %int1 = torch.constant.int 1\n"
...
"    %int2 = torch.constant.int 2\n"
"    %0 = call @__torch__.adaptive_max_pool(%arg0, %arg1, %int2) : (!torch.list<int>, !torch.list<int>, !torch.int) -> !torch.tuple<list<int>, list<int>>\n"
"    return %0 : !torch.tuple<list<int>, list<int>>\n"
"  }\n"
...
"    %int3 = torch.constant.int 3\n"
"    %0 = call @__torch__.adaptive_max_pool(%arg0, %arg1, %int3) : (!torch.list<int>, !torch.list<int>, !torch.int) -> !torch.tuple<list<int>, list<int>>\n"
"    return %0 : !torch.tuple<list<int>, list<int>>\n"
"  }\n"
