...
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.meshgrid.indexing\"(%arg0: !torch.list<list<int>>, %arg1: !torch.str) -> !torch.list<list<int>> {\n"
"    %true = torch.constant.bool true\n"
"    %str = torch.constant.str \"AssertionError: Only 'ij' and 'xy' are supported for the 'indexing' argument\"\n"
"    %str_0 = torch.constant.str \"ij\"\n"
"    %none = torch.constant.none\n"
"    %str_1 = torch.constant.str \"xy\"\n"
"    %int2 = torch.constant.int 2\n"
"    %int1 = torch.constant.int 1\n"
"    %int0 = torch.constant.int 0\n"
"    %0 = torch.aten.eq.str %arg1, %str_1 : !torch.str, !torch.str -> !torch.bool\n"
"    %1 = torch.prim.If %0 -> (!torch.list<list<int>>) {\n"
"      %6 = torch.aten.len.t %arg0 : !torch.list<list<int>> -> !torch.int\n"
"      %7 = torch.aten.ge.int %6, %int2 : !torch.int, !torch.int -> !torch.bool\n"
"      %8 = torch.prim.If %7 -> (!torch.list<list<int>>) {\n"
"        %9 = torch.aten.__getitem__.t %arg0, %int1 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"        %10 = torch.aten.__getitem__.t %arg0, %int0 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"        %11 = torch.prim.ListConstruct %9, %10 : (!torch.list<int>, !torch.list<int>) -> !torch.list<list<int>>\n"
"        %12 = torch.aten.slice.t %arg0, %int2, %none, %int1 : !torch.list<list<int>>, !torch.int, !torch.none, !torch.int -> !torch.list<list<int>>\n"
"        %13 = torch.aten.add.t %11, %12 : !torch.list<list<int>>, !torch.list<list<int>> -> !torch.list<list<int>>\n"
"        torch.prim.If.yield %13 : !torch.list<list<int>>\n"
"      } else {\n"
"        torch.prim.If.yield %arg0 : !torch.list<list<int>>\n"
"      }\n"
"      torch.prim.If.yield %8 : !torch.list<list<int>>\n"
"    } else {\n"
"      %6 = torch.aten.eq.str %arg1, %str_0 : !torch.str, !torch.str -> !torch.bool\n"
"      torch.prim.If %6 -> () {\n"
"        torch.prim.If.yield\n"
"      } else {\n"
"        torch.prim.RaiseException %str, %none : !torch.str, !torch.none\n"
...
"    }\n"
"    %2 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"    %3 = torch.aten.len.t %1 : !torch.list<list<int>> -> !torch.int\n"
"    torch.prim.Loop %3, %true, init() {\n"
"    ^bb0(%arg2: !torch.int):\n"
"      %6 = torch.aten.__getitem__.t %1, %arg2 : !torch.list<list<int>>, !torch.int -> !torch.list<int>\n"
"      %7 = func.call @__torch__.torch.jit._shape_functions.numel(%6) : (!torch.list<int>) -> !torch.int\n"
"      %8 = torch.aten.append.t %2, %7 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    %4 = torch.prim.ListConstruct  : () -> !torch.list<list<int>>\n"
"    %5 = torch.aten.len.t %1 : !torch.list<list<int>> -> !torch.int\n"
"    torch.prim.Loop %5, %true, init() {\n"
"    ^bb0(%arg2: !torch.int):\n"
"      %6 = torch.aten.append.t %4, %2 : !torch.list<list<int>>, !torch.list<int> -> !torch.list<list<int>>\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    return %4 : !torch.list<list<int>>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.meshgrid\"(%arg0: !torch.list<list<int>>) -> !torch.list<list<int>> {\n"
"    %str = torch.constant.str \"ij\"\n"
"    %0 = call @\"__torch_mlir_shape_fn.aten.meshgrid.indexing\"(%arg0, %str) : (!torch.list<list<int>>, !torch.str) -> !torch.list<list<int>>\n"
