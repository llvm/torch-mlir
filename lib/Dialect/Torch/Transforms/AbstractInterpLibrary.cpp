...
"    %1 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.get_dtype_of_scalar(%arg1) : (!torch.union<float, int>) -> !torch.int\n"
"    %2 = torch.aten.ne.int %0, %1 : !torch.int, !torch.int -> !torch.bool\n"
"    %3 = torch.prim.If %2 -> (!torch.int) {\n"
"      torch.prim.If.yield %int7 : !torch.int\n"
"    } else {\n"
"      %4 = func.call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.get_dtype_of_scalar(%arg0) : (!torch.union<float, int>) -> !torch.int\n"
"      torch.prim.If.yield %4 : !torch.int\n"
"    }\n"
"    return %3 : !torch.int\n"
"  }\n"
...
"    return %3 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.sub.int\"(%arg0: !torch.int, %arg1: !torch.int) -> !torch.int {\n"
"    %int4 = torch.constant.int 4\n"
...
"    %false = torch.constant.bool false\n"
"    %0 = torch.prim.Uninitialized : !torch.int\n"
"    %1 = torch.prim.ListConstruct %int11, %int0, %int1, %int2, %int3, %int4, %int15, %int5, %int6, %int7, %int9, %int10 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"    %2:3 = torch.prim.Loop %int9223372036854775807, %true, init(%false, %0, %int0) {\n"
"    ^bb0(%arg1: !torch.int, %arg2: !torch.bool, %arg3: !torch.int, %arg4: !torch.int):\n"
"      %4 = torch.aten.__getitem__.t %1, %arg4 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %5 = torch.aten.eq.int %4, %arg0 : !torch.int, !torch.int -> !torch.bool\n"
"      %6:3 = torch.prim.If %5 -> (!torch.bool, !torch.bool, !torch.int) {\n"
"        torch.prim.If.yield %false, %true, %arg4 : !torch.bool, !torch.bool, !torch.int\n"
"      } else {\n"
"        torch.prim.If.yield %true, %false, %0 : !torch.bool, !torch.bool, !torch.int\n"
"      }\n"
"      %7 = torch.aten.add.int %arg4, %int1 : !torch.int, !torch.int -> !torch.int\n"
"      %8 = torch.aten.lt.int %7, %int12 : !torch.int, !torch.int -> !torch.bool\n"
"      %9 = torch.aten.__and__.bool %8, %6#0 : !torch.bool, !torch.bool -> !torch.bool\n"
"      torch.prim.Loop.condition %9, iter(%6#1, %6#2, %7 : !torch.bool, !torch.int, !torch.int)\n"
"    } : (!torch.int, !torch.bool, !torch.bool, !torch.int, !torch.int) -> (!torch.bool, !torch.int, !torch.int)\n"
"    %3 = torch.prim.If %2#0 -> (!torch.int) {\n"
...
"    return %4 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.mul.int\"(%arg0: !torch.int, %arg1: !torch.int) -> !torch.int {\n"
"    %int4 = torch.constant.int 4\n"
"    return %int4 : !torch.int\n"
"  }\n"
...
"    return %7 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.add.int\"(%arg0: !torch.int, %arg1: !torch.int) -> !torch.int {\n"
"    %int4 = torch.constant.int 4\n"
"    return %int4 : !torch.int\n"
"  }\n"
