...
"    %false = torch.constant.bool false\n"
"    %str_0 = torch.constant.str \"size must be less than or equal to 1\"\n"
"    %none = torch.constant.none\n"
"    %str_1 = torch.constant.str \"AssertionError: \"\n"
...
"        torch.prim.If.yield\n"
"      } else {\n"
"        %6 = torch.aten.format(%str_0) : !torch.str -> !torch.str\n"
"        %7 = torch.aten.add.str %str_1, %6 : !torch.str, !torch.str -> !torch.str\n"
"        torch.prim.RaiseException %7, %none : !torch.str, !torch.none\n"
"        torch.prim.If.yield\n"
"      }\n"
...
"      %4 = torch.prim.If %3 -> (!torch.int) {\n"
"        %16 = torch.aten.add.int %arg1, %0 : !torch.int, !torch.int -> !torch.int\n"
"        torch.prim.If.yield %16 : !torch.int\n"
"      } else {\n"
"        torch.prim.If.yield %arg1 : !torch.int\n"
"      }\n"
...
"      %6 = torch.prim.If %5 -> (!torch.bool) {\n"
"        %16 = torch.aten.lt.int %4, %0 : !torch.int, !torch.int -> !torch.bool\n"
"        torch.prim.If.yield %16 : !torch.bool\n"
"      } else {\n"
"        torch.prim.If.yield %false : !torch.bool\n"
"      }\n"
...
"        torch.prim.If.yield\n"
"      } else {\n"
"        %16 = torch.aten.format(%str_2, %0) : !torch.str, !torch.int -> !torch.str\n"
...
"        torch.prim.If.yield\n"
"      } else {\n"
"        %16 = torch.aten.format(%str, %7) : !torch.str, !torch.int -> !torch.str\n"
"        %17 = torch.aten.add.str %str_1, %16 : !torch.str, !torch.str -> !torch.str\n"
"        torch.prim.RaiseException %17, %none : !torch.str, !torch.none\n"
"        torch.prim.If.yield\n"
"      }\n"
...
"      torch.prim.Loop %13, %true, init() {\n"
"      ^bb0(%arg4: !torch.int):\n"
"        %16 = torch.aten.__getitem__.t %arg0, %arg4 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %17 = torch.aten.append.t %12, %16 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      %14 = torch.aten._set_item.t %12, %4, %11 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"      %15 = torch.aten.append.t %12, %arg2 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
