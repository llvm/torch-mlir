...
"    return %arg0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten._scaled_dot_product_flash_attention\"(%arg0: !torch.list<int>, %arg1: !torch.list<int>, %arg2: !torch.list<int>, %arg3: !torch.float, %arg4: !torch.bool, %arg5: !torch.bool, %arg6: !torch.optional<float>) -> !torch.tuple<list<int>, list<int>, list<int>, list<int>, none, none, list<int>, list<int>, list<int>> {\n"
"    %none = torch.constant.none\n"
"    %int-1 = torch.constant.int -1\n"
"    %int1 = torch.constant.int 1\n"
"    %int0 = torch.constant.int 0\n"
...
"    %1 = torch.aten._set_item.t %arg0, %int-1, %0 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"    %2 = torch.aten.__getitem__.t %arg0, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %3 = torch.aten.__getitem__.t %arg0, %int2 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %4 = torch.aten.__getitem__.t %arg0, %int1 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %5 = torch.aten.__getitem__.t %arg0, %int3 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %6 = torch.prim.ListConstruct %2, %3, %4, %5 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"    %7 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"    %8 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"    %9 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"    %10 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"    %11 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"    %12 = torch.prim.TupleConstruct %arg0, %6, %7, %8, %none, %none, %9, %10, %11 : !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.none, !torch.none, !torch.list<int>, !torch.list<int>, !torch.list<int> -> !torch.tuple<list<int>, list<int>, list<int>, list<int>, none, none, list<int>, list<int>, list<int>>\n"
"    return %12 : !torch.tuple<list<int>, list<int>, list<int>, list<int>, none, none, list<int>, list<int>, list<int>>\n"
"  }\n"
...
"    return %0#1 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten._scaled_dot_product_flash_attention\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.tuple<int, int>, %arg2: !torch.tuple<int, int>, %arg3: !torch.float, %arg4: !torch.bool, %arg5: !torch.bool, %arg6: !torch.optional<float>) -> !torch.tuple<int, int, int, int, int, int, int, int, int> {\n"
"    %int4 = torch.constant.int 4\n"
"    %int6 = torch.constant.int 6\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1 = torch.prim.TupleConstruct %0#1, %int6, %int4, %int4, %int4, %int4, %int4, %int4, %0#1 : !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int, !torch.int -> !torch.tuple<int, int, int, int, int, int, int, int, int>\n"
"    return %1 : !torch.tuple<int, int, int, int, int, int, int, int, int>\n"
"  }\n"
