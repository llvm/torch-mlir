...
"    %str = torch.constant.str \"AssertionError: Input and indices mus be of the same rank\"\n"
"    %none = torch.constant.none\n"
"    %str_0 = torch.constant.str \"AssertionError: Input be of rank 4 or 5\"\n"
"    %true = torch.constant.bool true\n"
"    %int5 = torch.constant.int 5\n"
"    %int4 = torch.constant.int 4\n"
"    %int0 = torch.constant.int 0\n"
...
"    } else {\n"
"      %9 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"      %10 = torch.aten.eq.int %9, %int4 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %10 : !torch.bool\n"
"    }\n"
"    torch.prim.If %2 -> () {\n"
"      torch.prim.If.yield\n"
...
"    }\n"
"    %6 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"    %7 = torch.aten.eq.int %6, %int5 : !torch.int, !torch.int -> !torch.bool\n"
"    %8 = torch.prim.If %7 -> (!torch.list<int>) {\n"
"      %9 = torch.aten.__getitem__.t %arg0, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %10 = torch.aten.__getitem__.t %arg0, %int1 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %11 = torch.aten.__getitem__.t %arg2, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %12 = torch.aten.__getitem__.t %arg2, %int1 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %13 = torch.aten.__getitem__.t %arg2, %int2 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %14 = torch.prim.ListConstruct %9, %10, %11, %12, %13 : (!torch.int, !torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"      torch.prim.If.yield %14 : !torch.list<int>\n"
"    } else {\n"
"      %9 = torch.aten.__getitem__.t %arg0, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %10 = torch.aten.__getitem__.t %arg2, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %11 = torch.aten.__getitem__.t %arg2, %int1 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %12 = torch.aten.__getitem__.t %arg2, %int2 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %13 = torch.prim.ListConstruct %9, %10, %11, %12 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"      torch.prim.If.yield %13 : !torch.list<int>\n"
"    }\n"
"    return %8 : !torch.list<int>\n"
"  }\n"
