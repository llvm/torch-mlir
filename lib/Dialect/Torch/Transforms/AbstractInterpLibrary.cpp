...
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.__rshift__.Scalar\"(%arg0: !torch.list<int>, %arg1: !torch.float) -> !torch.list<int> {\n"
"    %0 = call @__torch__.torch.jit._shape_functions.unary(%arg0) : (!torch.list<int>) -> !torch.list<int>\n"
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.__lshift__.Scalar\"(%arg0: !torch.list<int>, %arg1: !torch.float) -> !torch.list<int> {\n"
"    %0 = call @__torch__.torch.jit._shape_functions.unary(%arg0) : (!torch.list<int>) -> !torch.list<int>\n"
"    return %0 : !torch.list<int>\n"
"  }\n"
...
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.bitwise_right_shift.Tensor_Scalar\"(%arg0: !torch.list<int>, %arg1: !torch.float) -> !torch.list<int> {\n"
"    %0 = call @__torch__.torch.jit._shape_functions.unary(%arg0) : (!torch.list<int>) -> !torch.list<int>\n"
"    return %0 : !torch.list<int>\n"
"  }\n"
...
"    return %0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.bitwise_left_shift.Tensor_Scalar\"(%arg0: !torch.list<int>, %arg1: !torch.float) -> !torch.list<int> {\n"
"    %0 = call @__torch__.torch.jit._shape_functions.unary(%arg0) : (!torch.list<int>) -> !torch.list<int>\n"
"    return %0 : !torch.list<int>\n"
"  }\n"
...
"    return %4 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.__rshift__.Scalar\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.number) -> !torch.int {\n"
"    %none = torch.constant.none\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
"    %false = torch.constant.bool false\n"
"    %int11 = torch.constant.int 11\n"
...
"    %1 = call @__torch__.torch_mlir.jit_ir_importer.build_tools.library_generator.is_integer_dtype(%0#1) : (!torch.int) -> !torch.bool\n"
"    %2 = torch.prim.If %1 -> (!torch.bool) {\n"
"      %7 = torch.aten.__isnot__ %0#1, %int11 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %7 : !torch.bool\n"
"    } else {\n"
"      torch.prim.If.yield %false : !torch.bool\n"
"    }\n"
...
"    return %6 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.__lshift__.Scalar\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.number) -> !torch.int {\n"
"    %none = torch.constant.none\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
"    %false = torch.constant.bool false\n"
"    %int11 = torch.constant.int 11\n"
...
"    return %4 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.bitwise_right_shift.Tensor_Scalar\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.number) -> !torch.int {\n"
"    %none = torch.constant.none\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1 = torch.prim.ListConstruct %0#0, %none : (!torch.int, !torch.none) -> !torch.list<optional<int>>\n"
"    %2 = call @__torch__.torch_mlir.jit_ir_importer.build_tools.library_generator.get_dtype_of_scalar(%arg1) : (!torch.number) -> !torch.int\n"
...
"    return %4 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.bitwise_left_shift.Tensor_Scalar\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.number) -> !torch.int {\n"
"    %none = torch.constant.none\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1 = torch.prim.ListConstruct %0#0, %none : (!torch.int, !torch.none) -> !torch.list<optional<int>>\n"
"    %2 = call @__torch__.torch_mlir.jit_ir_importer.build_tools.library_generator.get_dtype_of_scalar(%arg1) : (!torch.number) -> !torch.int\n"
