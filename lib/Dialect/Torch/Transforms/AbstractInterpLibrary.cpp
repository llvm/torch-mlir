...
"    return %arg0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.tensor\"(%arg0: !torch.list<any>, %arg1: !torch.optional<int>, %arg2: !torch.optional<Device>, %arg3: !torch.bool) -> !torch.list<int> {\n"
"    %0 = torch.aten.len.t %arg0 : !torch.list<any> -> !torch.int\n"
"    %1 = torch.prim.ListConstruct %0 : (!torch.int) -> !torch.list<int>\n"
"    return %1 : !torch.list<int>\n"
"  }\n"
...
"    return %1 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.tensor\"(%arg0: !torch.list<any>, %arg1: !torch.optional<int>, %arg2: !torch.optional<Device>, %arg3: !torch.bool) -> !torch.int {\n"
"    %int4 = torch.constant.int 4\n"
"    %none = torch.constant.none\n"
"    %0 = torch.aten.__is__ %arg1, %none : !torch.optional<int>, !torch.none -> !torch.bool\n"
"    %1 = torch.prim.If %0 -> (!torch.int) {\n"
