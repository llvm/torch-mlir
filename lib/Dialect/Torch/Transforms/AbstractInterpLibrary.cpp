...
"    %2 = torch.prim.ListConstruct %0#0, %none : (!torch.int, !torch.none) -> !torch.list<optional<int>>\n"
"    %3 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.get_dtype_of_scalar(%arg1) : (!torch.number) -> !torch.int\n"
"    %4 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.get_dtype_of_scalar(%arg2) : (!torch.number) -> !torch.int\n"
"    %5 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.get_dtype_of_scalar(%arg3) : (!torch.number) -> !torch.int\n"
"    %6 = torch.prim.ListConstruct  : () -> !torch.list<bool>\n"
"    %7 = torch.prim.ListConstruct %3, %4, %5 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"    torch.prim.Loop %int3, %true, init() {\n"
"    ^bb0(%arg4: !torch.int):\n"
"      %11 = torch.aten.__getitem__.t %7, %arg4 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %12 = func.call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.is_float_dtype(%11) : (!torch.int) -> !torch.bool\n"
"      %13 = torch.aten.append.t %6, %12 : !torch.list<bool>, !torch.bool -> !torch.list<bool>\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    %8 = torch.aten.any.bool %6 : !torch.list<bool> -> !torch.bool\n"
"    torch.prim.If %8 -> () {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %9 = torch.prim.ListConstruct %0#1, %5 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %10 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%2, %9) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    return %10 : !torch.int\n"
"  }\n"
