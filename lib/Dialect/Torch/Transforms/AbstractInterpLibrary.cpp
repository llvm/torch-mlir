...
"    %5 = torch.prim.If %4 -> (!torch.list<int>) {\n"
"      %6 = torch.aten.slice.t %arg0, %none, %int1, %int1 : !torch.list<int>, !torch.none, !torch.int, !torch.int -> !torch.list<int>\n"
"      torch.prim.If.yield %6 : !torch.list<int>\n"
"    } else {\n"
"      %6 = torch.derefine %arg0 : !torch.list<int> to !torch.any\n"
"      %7 = func.call @__torch__.torch.jit._shape_functions.zero_dim_tensor(%6) : (!torch.any) -> !torch.list<int>\n"
"      torch.prim.If.yield %7 : !torch.list<int>\n"
"    }\n"
"    return %5 : !torch.list<int>\n"
"  }\n"
