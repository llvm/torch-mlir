...
"    %int-1 = torch.constant.int -1\n"
"    %str_1 = torch.constant.str \"AssertionError: Expected 2D or 3D (batch mode) tensor for input with possibly 0 batch size and non zero dimensions for input\"\n"
"    %true = torch.constant.bool true\n"
"    %str_2 = torch.constant.str \"AssertionError: stride must be greater than 0\"\n"
"    %str_3 = torch.constant.str \"AssertionError: padding should be non negative\"\n"
"    %str_4 = torch.constant.str \"AssertionError: dilation should be greater than 0\"\n"
"    %str_5 = torch.constant.str \"AssertionError: kernel size should be greater than 0\"\n"
"    %false = torch.constant.bool false\n"
"    %str_6 = torch.constant.str \"AssertionError: padding is expected to have length 2\"\n"
"    %str_7 = torch.constant.str \"AssertionError: stride is expected to have length 2\"\n"
"    %str_8 = torch.constant.str \"AssertionError: dilation is expected to have length 2\"\n"
"    %str_9 = torch.constant.str \"AssertionError: kernel_size is expected to have length 2\"\n"
"    %none = torch.constant.none\n"
"    %str_10 = torch.constant.str \"AssertionError: output_size is expected to have length 2\"\n"
"    %int2 = torch.constant.int 2\n"
"    %int0 = torch.constant.int 0\n"
"    %int1 = torch.constant.int 1\n"
"    %int3 = torch.constant.int 3\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %4 = torch.aten.len.t %arg3 : !torch.list<int> -> !torch.int\n"
"    %5 = torch.aten.eq.int %4, %int2 : !torch.int, !torch.int -> !torch.bool\n"
"    torch.prim.If %5 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %6 = torch.aten.len.t %arg5 : !torch.list<int> -> !torch.int\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %8 = torch.aten.len.t %arg4 : !torch.list<int> -> !torch.int\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %10 = torch.aten.__getitem__.t %arg2, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %11 = torch.aten.gt.int %10, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %12 = torch.prim.If %11 -> (!torch.bool) {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %13 = torch.aten.__getitem__.t %arg3, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %14 = torch.aten.gt.int %13, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %15 = torch.prim.If %14 -> (!torch.bool) {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %16 = torch.aten.__getitem__.t %arg4, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %17 = torch.aten.ge.int %16, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %18 = torch.prim.If %17 -> (!torch.bool) {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %19 = torch.aten.__getitem__.t %arg5, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %20 = torch.aten.gt.int %19, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %21 = torch.prim.If %20 -> (!torch.bool) {\n"
...
"      torch.prim.If.yield %true : !torch.bool\n"
"    } else {\n"
"      %75 = torch.aten.eq.int %22, %int3 : !torch.int, !torch.int -> !torch.bool\n"
"      %76 = torch.prim.If %75 -> (!torch.bool) {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %27 = torch.aten.eq.int %22, %int3 : !torch.int, !torch.int -> !torch.bool\n"
"    %28 = torch.prim.If %27 -> (!torch.int) {\n"
"      torch.prim.If.yield %int0 : !torch.int\n"
"    } else {\n"
