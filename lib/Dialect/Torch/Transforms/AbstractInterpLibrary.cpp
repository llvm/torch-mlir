...
"    torch.prim.Loop %8, %true, init() {\n"
"    ^bb0(%arg8: !torch.int):\n"
"      %9 = torch.aten.__derive_index %arg8, %int2, %int1 : !torch.int, !torch.int, !torch.int -> !torch.int\n"
"      %10 = torch.prim.If %1 -> (!torch.int) {\n"
"        %29 = torch.aten.sub.int %9, %int2 : !torch.int, !torch.int -> !torch.int\n"
"        %30 = torch.aten.__getitem__.t %arg7, %29 : !torch.list<int>, !torch.int -> !torch.int\n"
...
"      %24 = torch.aten.sub.int %9, %int2 : !torch.int, !torch.int -> !torch.int\n"
"      %25 = torch.aten.__getitem__.t %arg5, %24 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %26 = torch.aten.add.int %23, %25 : !torch.int, !torch.int -> !torch.int\n"
"      %27 = torch.aten.add.int %26, %int1 : !torch.int, !torch.int -> !torch.int\n"
"      %28 = torch.aten.append.t %3, %27 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    return %3 : !torch.list<int>\n"
"  }\n"
