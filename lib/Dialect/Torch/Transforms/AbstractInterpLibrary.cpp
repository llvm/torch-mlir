...
"      %23 = torch.aten.format(%str_2, %22) : !torch.str, !torch.int -> !torch.str\n"
"      %24 = torch.aten.add.str %str_1, %23 : !torch.str, !torch.str -> !torch.str\n"
...
"          torch.prim.If.yield\n"
"        } else {\n"
"          %28 = torch.aten.format(%str_0, %26, %22) : !torch.str, !torch.int, !torch.list<int> -> !torch.str\n"
