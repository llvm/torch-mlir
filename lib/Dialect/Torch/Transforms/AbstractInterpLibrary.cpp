...
"    %1 = torch.prim.If %0 -> (!torch.int) {\n"
"      %17 = torch.prim.unchecked_cast %arg2 : !torch.optional<int> -> !torch.int\n"
"      torch.prim.If.yield %17 : !torch.int\n"
"    } else {\n"
"      torch.prim.If.yield %int0 : !torch.int\n"
"    }\n"
...
"    %3 = torch.prim.If %2 -> (!torch.int) {\n"
"      %17 = torch.prim.unchecked_cast %arg3 : !torch.optional<int> -> !torch.int\n"
"      torch.prim.If.yield %17 : !torch.int\n"
"    } else {\n"
"      %17 = func.call @__torch__.torch.jit._shape_functions.max_int() : () -> !torch.int\n"
"      torch.prim.If.yield %17 : !torch.int\n"
"    }\n"
"    %4 = torch.aten.lt.int %1, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %5 = torch.prim.If %4 -> (!torch.int) {\n"
"      %17 = torch.aten.__getitem__.t %arg0, %arg1 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %18 = torch.aten.add.int %1, %17 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %18 : !torch.int\n"
"    } else {\n"
"      torch.prim.If.yield %1 : !torch.int\n"
"    }\n"
"    %6 = torch.aten.lt.int %3, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %7 = torch.prim.If %6 -> (!torch.int) {\n"
"      %17 = torch.aten.__getitem__.t %arg0, %arg1 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %18 = torch.aten.add.int %3, %17 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %18 : !torch.int\n"
"    } else {\n"
"      torch.prim.If.yield %3 : !torch.int\n"
"    }\n"
"    %8 = torch.aten.gt.int %arg4, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %9 = torch.prim.If %8 -> (!torch.int) {\n"
"      torch.prim.If.yield %5 : !torch.int\n"
"    } else {\n"
"      %17 = torch.aten.add.int %7, %int1 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %17 : !torch.int\n"
"    }\n"
"    %10 = torch.aten.gt.int %arg4, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %11 = torch.prim.If %10 -> (!torch.int) {\n"
"      torch.prim.If.yield %7 : !torch.int\n"
"    } else {\n"
"      %17 = torch.aten.add.int %5, %int1 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %17 : !torch.int\n"
"    }\n"
"    %12 = torch.aten.gt.int %arg4, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %13 = torch.prim.If %12 -> (!torch.int) {\n"
"      torch.prim.If.yield %arg4 : !torch.int\n"
"    } else {\n"
"      %17 = torch.aten.neg.int %arg4 : !torch.int -> !torch.int\n"
"      torch.prim.If.yield %17 : !torch.int\n"
"    }\n"
"    %14 = torch.derefine %9 : !torch.int to !torch.optional<int>\n"
"    %15 = torch.derefine %11 : !torch.int to !torch.optional<int>\n"
"    %16 = call @__torch__.torch.jit._shape_functions.slice(%arg0, %arg1, %14, %15, %13) : (!torch.list<int>, !torch.int, !torch.optional<int>, !torch.optional<int>, !torch.int) -> !torch.list<int>\n"
"    return %16 : !torch.list<int>\n"
"  }\n"
