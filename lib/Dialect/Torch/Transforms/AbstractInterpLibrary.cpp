...
"  }\n"
"  func.func @__torch__.torch.jit._shape_functions.unfold(%arg0: !torch.list<int>, %arg1: !torch.int, %arg2: !torch.int, %arg3: !torch.int) -> !torch.list<int> {\n"
"    %true = torch.constant.bool true\n"
"    %str = torch.constant.str \"size must be less than or equal to {}\"\n"
"    %none = torch.constant.none\n"
"    %str_0 = torch.constant.str \"AssertionError: \"\n"
"    %str_1 = torch.constant.str \"dimension out of range of {}\"\n"
"    %false = torch.constant.bool false\n"
"    %int0 = torch.constant.int 0\n"
"    %int1 = torch.constant.int 1\n"
"    %0 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"    %1 = torch.aten.lt.int %arg1, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %2 = torch.prim.If %1 -> (!torch.int) {\n"
"      %14 = torch.aten.add.int %arg1, %0 : !torch.int, !torch.int -> !torch.int\n"
"      torch.prim.If.yield %14 : !torch.int\n"
"    } else {\n"
"      torch.prim.If.yield %arg1 : !torch.int\n"
"    }\n"
"    %3 = torch.aten.ge.int %2, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %4 = torch.prim.If %3 -> (!torch.bool) {\n"
"      %14 = torch.aten.lt.int %2, %0 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If.yield %14 : !torch.bool\n"
"    } else {\n"
"      torch.prim.If.yield %false : !torch.bool\n"
"    }\n"
...
"      torch.prim.If.yield\n"
"    } else {\n"
"      %14 = torch.aten.format(%str_1, %0) : !torch.str, !torch.int -> !torch.str\n"
"      %15 = torch.aten.add.str %str_0, %14 : !torch.str, !torch.str -> !torch.str\n"
"      torch.prim.RaiseException %15, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
"    %5 = torch.aten.__getitem__.t %arg0, %2 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %6 = torch.aten.le.int %arg2, %5 : !torch.int, !torch.int -> !torch.bool\n"
"    torch.prim.If %6 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
"      %14 = torch.aten.format(%str, %5) : !torch.str, !torch.int -> !torch.str\n"
"      %15 = torch.aten.add.str %str_0, %14 : !torch.str, !torch.str -> !torch.str\n"
"      torch.prim.RaiseException %15, %none : !torch.str, !torch.none\n"
"      torch.prim.If.yield\n"
"    }\n"
"    %7 = torch.aten.sub.int %5, %arg2 : !torch.int, !torch.int -> !torch.int\n"
"    %8 = torch.aten.floordiv.int %7, %arg3 : !torch.int, !torch.int -> !torch.int\n"
"    %9 = torch.aten.add.int %8, %int1 : !torch.int, !torch.int -> !torch.int\n"
"    %10 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"    %11 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"    torch.prim.Loop %11, %true, init() {\n"
"    ^bb0(%arg4: !torch.int):\n"
"      %14 = torch.aten.__getitem__.t %arg0, %arg4 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %15 = torch.aten.append.t %10, %14 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
"      torch.prim.Loop.condition %true, iter()\n"
"    } : (!torch.int, !torch.bool) -> ()\n"
"    %12 = torch.aten._set_item.t %10, %2, %9 : !torch.list<int>, !torch.int, !torch.int -> !torch.list<int>\n"
"    %13 = torch.aten.append.t %10, %arg2 : !torch.list<int>, !torch.int -> !torch.list<int>\n"
...
"    %0 = call @__torch__.torch.jit._shape_functions.unfold(%arg0, %arg1, %arg2, %arg3) : (!torch.list<int>, !torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"    return %0 : !torch.list<int>\n"
"  }\n"
