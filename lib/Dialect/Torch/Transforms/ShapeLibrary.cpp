...
"    %int-4 = torch.constant.int -4\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
"    %str_0 = torch.constant.str \"AssertionError: avg_pool2d: padding must be either a single int, or a tuple of two ints\"\n"
...
"    %int-3 = torch.constant.int -3\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
"    %str_0 = torch.constant.str \"AssertionError: avg_pool2d: padding must be a single int\"\n"
"    %str_1 = torch.constant.str \"AssertionError: avg_pool2d: stride must either be omitted, or a single int\"\n"
"    %true = torch.constant.bool true\n"
"    %none = torch.constant.none\n"
...
"    %21 = torch.aten.len.t %arg0 : !torch.list<int> -> !torch.int\n"
"    %22 = torch.aten.eq.int %21, %int3 : !torch.int, !torch.int -> !torch.bool\n"
"    %23 = torch.prim.If %22 -> (!torch.list<int>) {\n"
