...
module {
  ...
  func.func @main(%arg0: tensor<128x128xf32>) -> tensor<128x128xi1> {
    ...
    %1 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel"]} ins(%arg0, %arg0 : tensor<128x128xf32>, tensor<128x128xf32>) outs(%0 : tensor<128x128xi1>) {
