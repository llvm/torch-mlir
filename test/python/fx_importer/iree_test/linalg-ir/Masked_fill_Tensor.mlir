...
module {
  ...
  func.func @main(%arg0: tensor<128x128xf32>, %arg1: tensor<128x128xi1>, %arg2: tensor<i64>) -> (tensor<128x128xf32>, tensor<128x128xf32>) {
    %0 = tensor.empty() : tensor<f32>
    %1 = linalg.generic {indexing_maps = [#map, #map], iterator_types = []} ins(%arg2 : tensor<i64>) outs(%0 : tensor<f32>) {
    ^bb0(%in: i64, %out: f32):
      %4 = arith.sitofp %in : i64 to f32
      linalg.yield %4 : f32
    } -> tensor<f32>
