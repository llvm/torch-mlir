...
module {
  ...
  func.func @main(%arg0: tensor<128x128xf32>) -> (tensor<128x128xf32>, tensor<128x128xf32>) {
    ...
    %cst_0 = arith.constant 5.42101086E-20 : f32
    ...
    %global_seed_3 = ml_program.global_load @global_seed : tensor<i64>
    %extracted_4 = tensor.extract %global_seed_3[] : tensor<i64>
    %4 = arith.muli %extracted_4, %c6364136223846793005_i64 : i64
    %5 = arith.addi %4, %c1442695040888963407_i64 : i64
    %inserted_5 = tensor.insert %5 into %global_seed_3[] : tensor<i64>
    ml_program.global_store @global_seed = %inserted_5 : tensor<i64>
