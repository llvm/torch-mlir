...
module {
  ...
  func.func @main(%arg0: tensor<128x128xf32>) -> (tensor<f32>, tensor<f32>) {
    %cst = arith.constant 0.000000e+00 : f64
    %cst_0 = arith.constant 0.000000e+00 : f32
    %cst_1 = arith.constant 1.638300e+04 : f64
    %cst_2 = arith.constant 1.638400e+04 : f64
    %cst_3 = arith.constant 1.638400e+04 : f32
    ...
    ^bb0(%in: f64, %out: f64):
      %17 = arith.divf %in, %cst_1 : f64
      linalg.yield %17 : f64
    } -> tensor<f64>
    %12 = tensor.empty() : tensor<f32>
    %13 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = []} ins(%11 : tensor<f64>) outs(%12 : tensor<f32>) {
    ^bb0(%in: f64, %out: f32):
      %17 = arith.truncf %in : f64 to f32
      linalg.yield %17 : f32
    } -> tensor<f32>
    %14 = linalg.fill ins(%cst_0 : f32) outs(%12 : tensor<f32>) -> tensor<f32>
    %15 = linalg.generic {indexing_maps = [#map, #map2], iterator_types = ["reduction", "reduction"]} ins(%arg0 : tensor<128x128xf32>) outs(%14 : tensor<f32>) {
    ^bb0(%in: f32, %out: f32):
      %17 = arith.addf %in, %out : f32
      linalg.yield %17 : f32
    } -> tensor<f32>
    %16 = linalg.generic {indexing_maps = [#map3, #map3], iterator_types = []} ins(%15 : tensor<f32>) outs(%12 : tensor<f32>) {
    ^bb0(%in: f32, %out: f32):
      %17 = arith.divf %in, %cst_3 : f32
      linalg.yield %17 : f32
    } -> tensor<f32>
    return %13, %16 : tensor<f32>, tensor<f32>
  }
}
