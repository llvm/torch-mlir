...
# CHECK: torch.mlir
# CHECK:   {{\[}}[4.477[0-9]*  4.477[0-9]*  4.477[0-9]*  4.477[0-9]* ]
# CHECK:         [5.750[0-9]*  5.750[0-9]*  5.750[0-9]*  5.750[0-9]* ]
# CHECK:         [4.697[0-9]*  4.697[0-9]*  4.697[0-9]*  4.697[0-9]* ]
# CHECK:         [3.640[0-9]*  3.640[0-9]*  3.640[0-9]*  3.640[0-9]* ]{{\]}}
#
def test_sparse_gcn():
