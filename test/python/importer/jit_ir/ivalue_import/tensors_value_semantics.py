...
# CHECK: %[[ONES:.*]] = torch.vtensor.literal(dense<1.000000e+00> : tensor<1xf32>) : !torch.vtensor<[1],f32>
# CHECK: %[[ONES_I32:.*]] = torch.vtensor.literal(dense<1> : tensor<1xsi32>) : !torch.vtensor<[1],si32>
# CHECK: %[[ONES_I64:.*]] = torch.vtensor.literal(dense<1> : tensor<1xsi64>) : !torch.vtensor<[1],si64>
# CHECK: %[[ONES_F32:.*]] = torch.vtensor.literal(dense<1.000000e+00> : tensor<1xf32>) : !torch.vtensor<[1],f32>
# CHECK: %[[ONES_F64:.*]] = torch.vtensor.literal(dense<1.000000e+00> : tensor<1xf64>) : !torch.vtensor<[1],f64>
# CHECK: %[[ONES_BOOL:.*]] = torch.vtensor.literal(dense<true> : tensor<1xi1>) : !torch.vtensor<[1],i1>
# CHECK: %[[ONES_BF16:.*]] = torch.vtensor.literal(dense<1.000000e+00> : tensor<1xbf16>) : !torch.vtensor<[1],bf16>
# CHECK: %[[ONES_F16:.*]] = torch.vtensor.literal(dense<1.000000e+00> : tensor<1xf16>) : !torch.vtensor<[1],f16>
...
# CHECK: %[[ONES_QUINT8_DATA:.*]] = torch.vtensor.literal(dense<1> : tensor<1xui8>) : !torch.vtensor<[1],ui8>
# CHECK: %[[ONES_QUINT8:.*]] = torch.per_tensor_affine.create %[[ONES_QUINT8_DATA]], %[[SCALE]], %[[ZERO_POINT]] : !torch.vtensor<[1],ui8>, !torch.float, !torch.int -> !torch.vtensor<[1],!torch.quint8>
# CHECK: %[[ROOT:.*]] = torch.nn_module  {
# CHECK:   torch.slot "arange", %[[ARANGE]] : !torch.vtensor<[3],f32>
# CHECK:   torch.slot "ones", %[[ONES]] : !torch.vtensor<[1],f32>
# CHECK:   torch.slot "ones_i32", %[[ONES_I32]] : !torch.vtensor<[1],si32>
# CHECK:   torch.slot "ones_i64", %[[ONES_I64]] : !torch.vtensor<[1],si64>
# CHECK:   torch.slot "ones_f32", %[[ONES_F32]] : !torch.vtensor<[1],f32>
# CHECK:   torch.slot "ones_f64", %[[ONES_F64]] : !torch.vtensor<[1],f64>
# CHECK:   torch.slot "ones_bool", %[[ONES_BOOL]] : !torch.vtensor<[1],i1>
# CHECK:   torch.slot "ones_bf16", %[[ONES_BF16]] : !torch.vtensor<[1],bf16>
# CHECK:   torch.slot "ones_f16", %[[ONES_F16]] : !torch.vtensor<[1],f16>
# CHECK:   torch.slot "ones_qint8", %[[ONES_QINT8]] : !torch.vtensor<[1],!torch.qint8>
# CHECK:   torch.slot "ones_quint8", %[[ONES_QUINT8]] : !torch.vtensor<[1],!torch.quint8>
# CHECK: }
