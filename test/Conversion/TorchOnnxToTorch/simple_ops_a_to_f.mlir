...
// CHECK: %[[PADDED_INPUT:.*]] = torch.aten.constant_pad_nd %[[ARG]], {{.*}} : !torch.vtensor<[1,1024,6,6],f32>, !torch.list<int>, !torch.float -> !torch.vtensor<[1,1024,7,7],f32>
// CHECK: torch.aten.avg_pool2d %[[PADDED_INPUT]], {{.*}} : !torch.vtensor<[1,1024,7,7],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.bool, !torch.none -> !torch.vtensor<[1,1024,1,1],f32>
