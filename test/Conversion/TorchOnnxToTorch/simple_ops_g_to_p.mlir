...
func.func @test_gather(%arg0: !torch.vtensor<[3,4,5],f32>, %arg1: !torch.vtensor<[8,10,20,40], si64>) -> !torch.vtensor<[8,10,20,40,4,5],f32> attributes {torch.onnx_meta.opset_version = 13 : si64} {
  ...
  // CHECK: %[[SEL:.+]] = torch.aten.index_select %arg0, %[[INT0]], %arg1 : !torch.vtensor<[3,4,5],f32>, !torch.int, !torch.vtensor<[8,10,20,40],si64> -> !torch.vtensor<[8,10,20,40,4,5],f32>
  // CHECK: return %[[SEL]] : !torch.vtensor<[8,10,20,40,4,5],f32>
