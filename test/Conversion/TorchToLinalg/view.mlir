...
// CHECK:   %[[EXPAND:.*]] = tensor.expand_shape %[[COLLAPSE]] {{\[\[}}0, 1, 2], [3], [4]] output_shape [2, 3, 5, %{{.*}}, 6] : tensor<30x?x6xf32> into tensor<2x3x5x?x6xf32>
...
// CHECK:   %[[EXPAND:.*]] = tensor.expand_shape %[[COLLAPSE]] {{\[\[}}0, 1], [2], [3]] output_shape [2, 5, %{{.*}}, 6] : tensor<10x?x6xf32> into tensor<2x5x?x6xf32>
