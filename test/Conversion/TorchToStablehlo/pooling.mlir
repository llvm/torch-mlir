...
// CHECK:         %[[T14:.*]] = torch_c.from_builtin_tensor %[[T13]]#1 : tensor<?x?x?xi64> -> !torch.vtensor<[?,?,?],si64>
// CHECK:         %[[T15:.*]] = torch_c.from_builtin_tensor %[[T13]]#0 : tensor<?x?x?xf32> -> !torch.vtensor<[?,?,?],f32>
// CHECK:         return %[[T15]], %[[T14]] : !torch.vtensor<[?,?,?],f32>, !torch.vtensor<[?,?,?],si64>
