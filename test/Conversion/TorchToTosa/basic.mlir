...
// CHECK:           %[[VAL_0:.*]] = torch_c.to_builtin_tensor %[[VAL_0]] : !torch.vtensor<[1,6,4],f32> -> tensor<1x6x4xf32>
...
// CHECK:           %[[VAL_5:.*]] = tosa.reshape %[[VAL_0]] {new_shape = array<i64: 1, 2, 3, 4>} : (tensor<1x6x4xf32>) -> tensor<1x2x3x4xf32>
