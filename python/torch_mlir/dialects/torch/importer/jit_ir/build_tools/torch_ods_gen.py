...
def emit_aten_ops(torch_ir_dir: str, registry: Registry):
    ...
    with open(td_file, "w") as f:
        ...
        emit("aten::sparse_sampled_addmm.out : (Tensor, Tensor, Tensor, Scalar, Scalar, Tensor) -> (Tensor)")
        emit("aten::sparse_sampled_addmm : (Tensor, Tensor, Tensor, Scalar, Scalar) -> (Tensor)")
        ...
        emit("aten::arctan2_ : (Tensor, Tensor) -> (Tensor)")
        emit("aten::arctan2 : (Tensor, Tensor) -> (Tensor)")
        emit("aten::arctan2.out : (Tensor, Tensor, Tensor) -> (Tensor)")
        ...
        emit("aten::_convolution_double_backward : (Tensor?, Tensor?, Tensor?, Tensor, Tensor, Tensor, int[], int[], int[], bool, int[], int, bool[]) -> (Tensor, Tensor, Tensor)")
        ...
        emit("aten::quantize_per_tensor_dynamic : (Tensor, int, bool) -> (Tensor)")
        ...
        emit("aten::nanquantile : (Tensor, Tensor, int?, bool, str) -> (Tensor)")
        emit("aten::nanquantile.scalar : (Tensor, float, int?, bool, str) -> (Tensor)")
        emit("aten::nanquantile.out : (Tensor, Tensor, int?, bool, str, Tensor) -> (Tensor)")
        emit("aten::nanquantile.scalar_out : (Tensor, float, int?, bool, str, Tensor) -> (Tensor)")
        emit("aten::_foreach_sin_ : (Tensor[]) -> ()")
        emit("aten::quantile : (Tensor, Tensor, int?, bool, str) -> (Tensor)")
        emit("aten::quantile.scalar : (Tensor, float, int?, bool, str) -> (Tensor)")
        emit("aten::quantile.out : (Tensor, Tensor, int?, bool, str, Tensor) -> (Tensor)")
        emit("aten::quantile.scalar_out : (Tensor, float, int?, bool, str, Tensor) -> (Tensor)")
        ...
        emit("aten::searchsorted.Tensor : (Tensor, Tensor, bool, bool, str?, Tensor?) -> (Tensor)")
        emit("aten::searchsorted.Scalar : (Tensor, Scalar, bool, bool, str?, Tensor?) -> (Tensor)")
        emit("aten::searchsorted.Tensor_out : (Tensor, Tensor, bool, bool, str?, Tensor?, Tensor) -> (Tensor)")
        ...
        emit("aten::_upsample_nearest_exact1d : (Tensor, int[], float?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact1d.vec : (Tensor, int[]?, float[]?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact1d.out : (Tensor, int[], float?, Tensor) -> (Tensor)")
        ...
        emit("aten::_upsample_nearest_exact3d : (Tensor, int[], float?, float?, float?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact3d.vec : (Tensor, int[]?, float[]?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact3d.out : (Tensor, int[], float?, float?, float?, Tensor) -> (Tensor)")
        ...
        emit("aten::_scatter_reduce : (Tensor, int, Tensor, str, int?) -> (Tensor)")
        emit("aten::_scatter_reduce.out : (Tensor, int, Tensor, str, int?, Tensor) -> (Tensor)")
        ...
        emit("aten::_upsample_nearest_exact2d : (Tensor, int[], float?, float?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact2d.vec : (Tensor, int[]?, float[]?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact2d.out : (Tensor, int[], float?, float?, Tensor) -> (Tensor)")
        ...
        emit("aten::_new_zeros_with_same_feature_meta : (Tensor, Tensor, int) -> (Tensor)")
        ...
        emit("aten::linalg_solve_triangular : (Tensor, Tensor, bool, bool, bool) -> (Tensor)")
        emit("aten::linalg_solve_triangular.out : (Tensor, Tensor, bool, bool, bool, Tensor) -> (Tensor)")
        ...
        emit("aten::_convert_indices_from_csr_to_coo : (Tensor, Tensor, bool, bool) -> (Tensor)")
        emit("aten::_convert_indices_from_csr_to_coo.out : (Tensor, Tensor, bool, bool, Tensor) -> (Tensor)")
        ...
        emit("aten::index_add : (Tensor, int, Tensor, Tensor, Scalar) -> (Tensor)")
        ...
        emit("aten::index_add_ : (Tensor, int, Tensor, Tensor, Scalar) -> (Tensor)")
        ...
        emit("aten::_foreach_norm.Scalar : (Tensor[], Scalar) -> (Tensor[])")
        ...
        emit("aten::softplus_backward.grad_input : (Tensor, Tensor, Scalar, Scalar, Tensor) -> (Tensor)")
        ...
        emit("aten::_upsample_nearest_exact3d_backward.vec : (Tensor, int[]?, int[], float[]?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact3d_backward : (Tensor, int[], int[], float?, float?, float?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact3d_backward.grad_input : (Tensor, int[], int[], float?, float?, float?, Tensor) -> (Tensor)")
        ...
        emit("aten::_upsample_bilinear2d_aa : (Tensor, int[], bool, float?, float?) -> (Tensor)")
        emit("aten::_upsample_bilinear2d_aa.out : (Tensor, int[], bool, float?, float?, Tensor) -> (Tensor)")
        emit("aten::_upsample_bilinear2d_aa.vec : (Tensor, int[]?, bool, float[]?) -> (Tensor)")
        emit("aten::_upsample_bilinear2d_aa_backward : (Tensor, int[], int[], bool, float?, float?) -> (Tensor)")
        emit("aten::_upsample_bilinear2d_aa_backward.grad_input : (Tensor, int[], int[], bool, float?, float?, Tensor) -> (Tensor)")
        emit("aten::_upsample_bilinear2d_aa_backward.vec : (Tensor, int[]?, int[], bool, float[]?) -> (Tensor)")
        ...
        emit("aten::_upsample_nearest_exact1d_backward : (Tensor, int[], int[], float?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact1d_backward.grad_input : (Tensor, int[], int[], float?, Tensor) -> (Tensor)")
        emit("aten::_upsample_nearest_exact1d_backward.vec : (Tensor, int[]?, int[], float[]?) -> (Tensor)")
        ...
        emit("aten::_upsample_nearest_exact2d_backward : (Tensor, int[], int[], float?, float?) -> (Tensor)")
        emit("aten::_upsample_nearest_exact2d_backward.grad_input : (Tensor, int[], int[], float?, float?, Tensor) -> (Tensor)")
        emit("aten::_upsample_nearest_exact2d_backward.vec : (Tensor, int[]?, int[], float[]?) -> (Tensor)")
        ...
        emit("aten::_slow_conv2d_forward : (Tensor, Tensor, int[], Tensor?, int[], int[]) -> (Tensor)")
        emit("aten::_slow_conv2d_forward.output : (Tensor, Tensor, int[], Tensor?, int[], int[], Tensor) -> (Tensor)")
        emit("aten::_slow_conv2d_backward.grad_input : (Tensor, Tensor, Tensor, int[], int[], int[], Tensor, Tensor, Tensor) -> (Tensor, Tensor, Tensor)")
        emit("aten::_slow_conv2d_backward.output_mask : (Tensor, Tensor, Tensor, int[], int[], int[], bool[]) -> (Tensor, Tensor, Tensor)")
        emit("aten::slow_conv3d_forward : (Tensor, Tensor, int[], Tensor?, int[], int[]) -> (Tensor)")
        emit("aten::slow_conv3d_forward.output : (Tensor, Tensor, int[], Tensor?, int[], int[], Tensor) -> (Tensor)")
        ...
        emit("aten::linalg_cross : (Tensor, Tensor, int) -> (Tensor)")
        emit("aten::linalg_cross.out : (Tensor, Tensor, int, Tensor) -> (Tensor)")
