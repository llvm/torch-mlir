...
# CHECK:           %[[COND_INIT:.*]] = torch.aten.lt.float_int %[[F_INIT]], %[[VAL_0]] : f64, i64 -> !torch.bool
...
# CHECK:             %[[COND_ITER:.*]] = torch.aten.lt.float_int %[[F_NEXT]], %[[VAL_0]] : f64, i64 -> !torch.bool
...
# CHECK:           } : (i64, !torch.bool, !torch.optional<i64>) -> !torch.optional<i64>
